...
function OutboundPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-white">Outbound Shipments</h1>
        <p className="text-sm text-slate-500 mt-0.5">Manage & track outgoing orders</p>
      </div>
      <div className="glass-card p-12 text-center">
        <p className="text-slate-500 text-sm">Outbound module coming soon...</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-0.5">Warehouse performance insights</p>
      </div>
      <div className="glass-card p-12 text-center">
        <p className="text-slate-500 text-sm">Reports module coming soon...</p>
      </div>
    </div>
  );
}
